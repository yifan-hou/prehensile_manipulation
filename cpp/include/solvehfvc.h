...
/**
 * Solve the hybrid servoing problem, for a system of kDOF = @p kDimActualized +
 * @p kDimUnActualized dimensions. This means the generalized force f and
 * generalized velocity v are kDOF dimensional. The first @p kDimUnActualized
 * dimensions correspond to the free DOFs in the system (such as free objects),
 * while the last @p kDimActualized DOFs correspond to the controllable DOFs
 ...
 */
bool solvehfvc(const Eigen::MatrixXd &N,
